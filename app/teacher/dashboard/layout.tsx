...
export default function DashboardLayout({
    ...
    const menuItems = [
        ...
        { label: "Courses Management", href: "/teacher/dashboard/courses" },
        { label: "Add Course", href: "/teacher/dashboard/add-course" },
        { label: "Quiz", href: "/teacher/dashboard/quiz" },
        { label: "Students", href: "/teacher/dashboard/children" },
        { label: "Discuss", href: "/teacher/dashboard/discuss" },
        { label: "Classes", href: "/teacher/dashboard/classes" },
        { label: "Doro EDU AI", href: "/teacher/dashboard/doro-edu-ai" },
        { label: "Award", href: "/teacher/dashboard/award" },
    ];
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`text-lg relative z-10 flex items-center justify-center w-5 ${isActive ? 'text-black' : 'text-[#969696]'}`}>
                                    ...
                                    {item.label === 'Quiz' && (
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill={isActive ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2">
                                            <path d="M9 11H3v2h6v-2zm0 4H3v2h6v-2zm0-8H3v2h6V7zm6 0v2h6V7h-6zm0 4v2h6v-2h-6zm0 4v2h6v-2h-6z" />
                    ...
                    <div className="flex items-center gap-3 md:gap-4 shrink-0">
                        ...
                        <div className="relative">
                            ...
                            <div id="messages-dropdown" className="hidden absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-100 z-50">
                                ...
                                <div className="p-3 text-center border-t border-gray-100">
                                    <Link href="/teacher/dashboard/discuss" className="text-sm text-blue-600 hover:text-blue-700 font-medium">View all messages</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div id="profile-dropdown" className="hidden absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-100 z-50">
                                ...
                                <div className="py-2">
                                    <Link href="/teacher/dashboard" className="w-full px-4 py-2.5 text-left text-sm hover:bg-gray-50 flex items-center gap-3 block">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                                            <circle cx="12" cy="7" r="4" />
                                        </svg>
